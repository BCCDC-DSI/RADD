...
def _parse_args():
    ...
    parser.add_argument('-p', '--preprocessor', default='', help='Path to preprocessor file')
    parser.add_argument('-models', '--ml_models', default='', help='Path to Machine Learning Models')
