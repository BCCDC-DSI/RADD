...
#
#
# sbatch submit_loop_array.sh /arc/project/st-cfjell-1/ms_data/expedited_2023/mzML/ /arc/project/st-ashapi01-1/RADD_libraries/HRN_2023-10-01_v4_v5.csv /scratch/st-ashapi01-1/debug/ 200 3 5
#
...
if (length(args)>1)
{
  print(paste("Run inner3.R with arguments: folder containing mzML:", args[1], '\nLibrary path:', args[2], '\nOutput folder:', args[3], '\nAnalyzing batch #',args[4], 'of', args[5], '\n\n\n' ))
  inp_dir = args[1]
  db_filename = args[2]
  out_dir = args[3]
